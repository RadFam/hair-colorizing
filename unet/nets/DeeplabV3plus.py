...
def DeeplabV3plus(weights='pascal_voc', input_tensor=None, input_shape=(512, 512, 3), classes=1, backbone='mobilenetv2', OS=8, alpha=1.):
    ...
    if weights == 'pascal_voc' and alpha == 1:
        if backbone == 'xception':
